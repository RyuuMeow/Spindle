...
正式產品不再引用示範工作區；The Last Light 的公開範例位於 examples/demo-project/the-last-light/，scripts/fixtures/sample.ts 由其產生並檢查一致性。封裝白名單涵蓋 MCP runtime、視窗模組、系統字型查詢與 licenses，並以實際 Portable 驗證。
