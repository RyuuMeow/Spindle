"use client";
import { t as tr } from "../../app/i18n/index.ts";
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        ...
        {showCloseButton && (
          ...
          >
            <XIcon />
            <span className="sr-only">{tr("mc7fdddf79eaa")}</span>
          </DialogPrimitive.Close>
        )}
      </DialogPrimitive.Content>
    </DialogPortal>
    ...
    >
      ...
      {showCloseButton && (
        <DialogPrimitive.Close asChild>
          <Button variant="outline">{tr("mc7fdddf79eaa")}</Button>
        </DialogPrimitive.Close>
      )}
    </div>
  );
