...
| `pnpm test:unit`, `pnpm test:mcp`, `pnpm test:agent-installation`, `pnpm test:release` | Passed: 192 unit, 25 MCP, 12 agent installation and 7 release tests. The release suite covers Windows CRLF notes. One isolated MCP loopback request timed out on the first run; its unchanged rerun passed. |
